...
st.markdown("<h1 style='text-align: center; color: black;'>Crop Recommendation System For Farmers</h1>", unsafe_allow_html=True)
st.markdown("<h5 style='text-align: center;'>This Application, part of our CSP, predicts what is the best crop to plant based on NPK values and Weather Conditions!</h5>", unsafe_allow_html= True)
...
with coly:
    st.markdown("""
      ...
      <h6 style='text-align: center;'>
        This Application is a Part of Our CSP project which is under Deployment.
        We are going to deploy it Using the Containerization tecnhnologies like
